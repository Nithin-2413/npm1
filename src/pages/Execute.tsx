        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={2}
              disabled={isRunning}
              className="w-full font-mono text-sm text-foreground/60 bg-muted/10 rounded-lg px-3 py-2 border border-glass-border/40 outline-none focus:ring-1 focus:ring-primary/40 resize-none placeholder:text-muted-foreground/40 disabled:opacity-60 disabled:cursor-not-allowed"
